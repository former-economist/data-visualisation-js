import {population} from "./population.fetch.js"
import { feature, mesh } from "topojson";
import { descending, scaleSqrt, geoPath, max, create, format as myFormat} from "d3";
import "d3"
import { centroid } from "./centroid.js";
import { us, statemap, countymap,} from "./data.js";
...
function chart() {
    ...
    const radius = scaleSqrt([0, max(data, d => d.population)], [0, 40]);
